 ...
 * @package Numbers_Words
 */
namespace LLA\Numbers\Words\Locale\hu;
 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class HU extends Words implements LocaleInterface
{
    /**
     * Locale name
     * @var string
     ...
     */
    function getWords($num, $options = array(), $power = 0, $powsuffix = '', $gt2000 = false)
    {
        $chk_gt2000 = true;
