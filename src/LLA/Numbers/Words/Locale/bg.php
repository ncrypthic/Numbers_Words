 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class bg extends Words implements LocaleInterface
{
     ...
     * in the initDigits() method, which is invoked from the constructor.
     * @var string
     * @access private
     */
    var $_digits = array(
    ...
    /**
     * The class constructor, used for calling the initDigits method.
     *
     * @return void
     *
     * @access public
     * @author Kouber Saparev <kouber@php.net>
     * @see function initDigits
     */
     ...
     */
    function getWords($num = 0, $power = null, $powsuffix = null)
    {
        $ret = array();
