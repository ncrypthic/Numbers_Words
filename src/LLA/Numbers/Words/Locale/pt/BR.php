 ...
 */
namespace LLA\Numbers\Words\Locale\pt;
 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class BR extends Words implements LocaleInterface
{
    /**
     * Locale name
     * @var string
    ...
    private $_words = array(
        ...
        array(
            '',         // 0: not displayed
            'cento',    // 'cem' is a special case handled in getWords()
            'duzentos',
            'trezentos',
            'quatrocentos',
            'quinhentos',
    ...
    private function parseChunk($chunk)
    {
        ...
        return array_merge(array($word), $this->parseChunk(substr($chunk, 1)));
    }
