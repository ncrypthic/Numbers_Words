 ...
 */
namespace LLA\Numbers\Words\Locale\zh;
 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class HKFN extends Words implements LocaleInterface
{
    /**
     * Locale name
     * @var string
     ...
     * @access public
     */
    public $lang = 'Traditional Chinese';
     ...
     * @access public
     */
    public $lang_native = 'Traditional Chinese';
     ...
     */
    public function getWords($num, $power = 0, $powsuffix = '')
    {
        $ret = '';
